...
import time
import logging
import DetectNewVideosAndTimestampThem.MakeTimestampOnNewVideo as MakeTimestamp
...
def init_scheduler(api_client, scheduler_delay, channel_id, new_videos_location):
    ...
    scheduler.enter(delay, 1, check_if_there_is_new_video_upload, (api_client, channel_id, None, playlist_id,
                                                                   new_videos_location))
    scheduler.run()


def check_if_there_is_new_video_upload(api_client, channel_id, last_video_id, playlist_id, new_videos_location):
    ...
    # TODO: Remove
    MakeTimestamp.make_timestamp_on_new_video(api_client, channel_id, current_last_video_id, new_videos_location)
    ...
    scheduler.enter(delay, 1, check_if_there_is_new_video_upload, (api_client, channel_id, last_video_id, playlist_id,
                                                                   new_videos_location))
